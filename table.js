...
$("document").ready(function () {
    $("#btnAdd2").click(function (addrow) {
        $(" < tr ><th>new id 2</th><th>new name 2</th><th>new description 2</th><th>'<img src = 'https://images.freeimages.com/images/large-previews/a31/colorful-umbrella-1176220.jpg' style: width = 50 >'</th> </tr > ").insertAfter($("#btnAdd1"))
    });
});
$("document").ready(function () {
